...
from pyframe.log.errors import AttributeMissing, TooSmallError
...
from pyframe.screen.grid.matrix import Cell, Junction, Matrix
from pyframe.screen.grid.nested import level_out
...
f = Frame(Cell.from_size(Size(5, 12)), border_type=Borders.THIN)

f.add_frame(Frame(Cell.from_size(Size(2, 5))), Coord(1, 1))
